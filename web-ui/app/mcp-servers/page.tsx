...
export default function MCPServersPage() {
  ...
  const { items: repoItems, loading: repoLoading } = useRepoItems(selectedRepo, 'mcp')
  ...
  return (
    <div className="min-h-screen">
      ...
      <ItemCrudDialog open={showCreate} onOpenChange={setShowCreate} itemType="mcp" onSaved={() => { setShowCreate(false); if (!selectedRepo) fetchGlobal() }} />
    </div>
  )
}
